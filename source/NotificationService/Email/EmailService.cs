...
namespace NotificationService
{
    public sealed class EmailService : IEmailService
    {
        ...
        public async Task<IResult> SendAsync(Email email)
        {
        ...
        private static async Task<IResult> ValidateAsync(Smtp smtp)
        {
            return GetResult(await new SmtpValidator().ValidateAsync(smtp));
        }

        private static async Task<IResult> ValidateAsync(Email email)
        {
